    ...
    <main className="wrapper container py-20">
      <div className="mx-auto max-w-lg rounded-[2rem] bg-white/90 p-8 shadow-[0_25px_70px_rgba(15,23,42,0.15)] backdrop-blur-xl">
        ...
        <p className="text-sm text-slate-600 mb-6">
          Sign up with your email address or phone number. If your Clerk app is configured for phone-only authentication, you may need to update the Clerk settings to enable email sign up.
        </p>
